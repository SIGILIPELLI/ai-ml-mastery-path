...
| Level | Focus | Modules |
|-------|-------|---------|
| [Level 1 · Entry](level-1/index.md) | NumPy/pandas, scikit-learn, model evaluation, first PyTorch network | 9 topics + 1 project |
| [Level 2 · Intermediate](level-2/index.md) | Gradient boosting, time series, NLP basics, CNNs, interpretability | 9 topics + 1 project |
| [Level 3 · Advanced](level-3/index.md) | Transformers, MLOps, experiment tracking, distributed training | 9 topics + 1 project |
| [Level 4 · Master](level-4/index.md) | Production ML systems, serving at scale, monitoring & drift | 9 topics + 1 capstone |
...
- Every topic page has runnable code snippets — all you need is
  `pip install numpy pandas scikit-learn matplotlib torch`. Examples use
  small built-in or synthetic datasets, so there is nothing to download.
...
This site deliberately focuses on the classical-ML + deep-learning
foundation. Two sibling sites pick up where it leaves off:

- [RAG Mastery Path](https://sigilipelli.github.io/rag-skillmastery/) — retrieval-augmented generation pipelines
- [LLM Development Mastery Path](https://sigilipelli.github.io/llm-dev-skillmastery/) — building applications on large language models
